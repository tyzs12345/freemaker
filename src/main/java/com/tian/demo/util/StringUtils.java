...
public class StringUtils {
	...
	/**
	 * 将String数组的内容转成带分割符的String
	 * 
	 * @param strs
	 * @param separator
	 * @return
	 */
	public static String toStringWithSeparator(String[] strs, String separator) {
	...
	public static int getStringLengh(String text) {
		if (text != null) {
			int length = 0;
			for (int i = 0; i < text.length(); i++) {
				length += text.charAt(i) > 128 ? 2 : 1;
			}
			return length;
		} else {
			return 0;
