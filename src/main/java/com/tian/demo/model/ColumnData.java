...
public class ColumnData {
	...
	private String propTypeLowerCase;
	/**
	 * 数据库映射的Mybatis类型
	 */
	...
	public String getPropTypeLowerCase() {
	...
	public void setPropTypeLowerCase(String propTypeLowerCase) {
		this.propTypeLowerCase = propTypeLowerCase;
	}
